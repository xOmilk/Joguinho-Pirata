...
public class MyWorld extends World
{
    ...
    private String movimentoInimigo = "Aperte W, A, S, D para movimentar o inimigo";
    private String armaDisparoInimigo = "Aperte E para pegar a arma e F para atirar";
    public MyWorld()
    {    
        super(1200, 500, 1); 
        mostrarTextoVida();
    ...
    public void mostrarTextoVida() {
        ...
        showText("Vida do Inimigo: 30", 950, 20);
    }
    ...
    private void mostrarTeclas() {
        ...
        showText(movimentoInimigo, 990, getHeight() - 60);
        showText(armaDisparoInimigo, 990, getHeight() - 35);
    ...
    public void atualizarVidaInimigo(int vida) {
        showText("Vida do Inimigo: " + vida, 950, 20);
    }
